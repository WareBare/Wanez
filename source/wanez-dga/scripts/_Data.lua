...
--
local dgaAffix = {
    [1]={5,{15,25}}, -- use additional proxies
    [2]={2,{25,50}}, -- increased Pack Size (more common and champions)
    [3]={3,{30,60}}, -- more Champions
    [4]={1,{40,60}}, -- more Heroes
    [5]={1,{}} -- twinned, double boss
}
