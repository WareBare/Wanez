...
--
local function genDifficultyID(self)
    local retValue = 1
...
function wanez.dga.hideoutTrigger(argObjectId)
    if(Server and wanez.dga.Settings:getSpawnTrigger() == false) then
        resetGlobal()
...
function wanez.dga.tempPortalOnInteract(argObjectId)
    ...
    --wanez.dga.Settings:setFloorRegionCount()
    dgaBlockPortalCollector = false
    wanez.dga.var.BlockProxyCleanUp = false
end
...
function wanez.dga.spawnBlacksmithDGA(argObjectId)
    if Server then
        ...
        curBlacksmith = Entity.Create(smithDBR[genDifficultyID()])
        --curBlacksmith = Character.Create(smithDBR[genDifficultyID()],100,nil)
        curBlacksmith:SetCoords(Proxy.Get(argObjectId):GetCoords())
        --end
    end
end
--
local function setPortalDataToArea(argObjectId,argAreaId,argLayoutId,argFloorCount,argRegionCount)
    argFloorCount = argFloorCount or 1
    argRegionCount = argRegionCount or 1
    if(Server)then
        ...
        if(wanez.dga.Data.Portals[argAreaId][argLayoutId] == nil)then
            ...
            wanez.dga.Data.Portals[argAreaId][argLayoutId]:setFloorRegionCount(argFloorCount,argRegionCount)
...
--function wanez.dga.regPortalBasicDGA_001_B_00(argObjectId) setPortalDataToArea(argObjectId,1,2);end;
...
function wanez.dga.regPortalBasicDGA_002_B_00(argObjectId) setPortalDataToArea(argObjectId,2,2);end;
...
function wanez.dga.regPortalBasicDGA_003_B_00(argObjectId) setPortalDataToArea(argObjectId,3,2);end;
...
-- ID: 5
function wanez.dga.regPortalBasicDGA_005_A_00(argObjectId) setPortalDataToArea(argObjectId,5,1);end;
...
-- ID: 11
function wanez.dga.regPortalBasicDGA_011_A_00(argObjectId) setPortalDataToArea(argObjectId,11,1,3);end;
-- ID: 12
function wanez.dga.regPortalBasicDGA_012_A_00(argObjectId) setPortalDataToArea(argObjectId,12,1);end;
-- ID: 13
function wanez.dga.regPortalBasicDGA_013_A_00(argObjectId) setPortalDataToArea(argObjectId,13,1);end;
-- ID: 14
function wanez.dga.regPortalBasicDGA_014_A_00(argObjectId) setPortalDataToArea(argObjectId,14,1);end;
-- ID: 15
function wanez.dga.regPortalBasicDGA_015_A_00(argObjectId) setPortalDataToArea(argObjectId,15,1);end;

-- ID: 101
function wanez.dga.regPortalEndlessDGA_001_A_00(argObjectId) setPortalDataToArea(argObjectId,901,1);end;
-- ID: 102
function wanez.dga.regPortalEndlessDGA_002_A_00(argObjectId) setPortalDataToArea(argObjectId,902,1);end;
