...
function wanez.DGA.onEnterTriggerCampOnLoad(argObjectId)
    ...
    --- RUNES
    --_player:wzHasItem("mod_wanez/_runes/items/materia/runeb_069.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/materia/runeb_066.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/materia/runeb_008.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/materia/runeb_036.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/stones/stone_accessory_medal02.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/stones/stone_accessory_medal04.dbr",1)

    --_player:wzHasItem("mod_wanez/_runes/items/materia/runeb_077.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/materia/runeb_030.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/stones/stone_armor_feet02.dbr",1)
    --_player:wzHasItem("mod_wanez/_runes/items/stones/stone_armor_feet04.dbr",1)
